package uz.lab.tutor.RedisTest;
...
import uz.lab.tutor.config.RedisConfig;
...
@Import({ RedisConfig.class, ItemService.class })
...
//            this.redisServer = new RedisServer("redis",6379);
//        }
//
//    }
